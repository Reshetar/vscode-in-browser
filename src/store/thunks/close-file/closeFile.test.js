...
describe('closeFile', () => {
    ...
    describe('when there are 2 or more active files', () => {
        ...
        it('should remove the editor active file id and set the new editor active file id to be the one on right', () => {
            getState.mockReturnValue({ files: { activeFilesIds: ['1', '2'], editorActiveFileId: '1' } });
            closeFile('1')(dispatch, getState);
            expect(dispatch).toBeCalledTimes(2);
        ...
        it('should remove the editor active file id and set the new editor active file id to be the one on left', () => {
